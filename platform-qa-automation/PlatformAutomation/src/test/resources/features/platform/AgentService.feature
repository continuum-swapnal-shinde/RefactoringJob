Feature: Agent Service API
  ...
  @PlatformBVT @PlatformRegressions @Win7_32Bit @Win7_64Bit @Win8_32Bit @Win8_64Bit @Win10_32Bit @Win10_64Bit @Win8.1_32Bit @WinServer8_64Bit @WinServer12_64Bit @WinServer16_64Bit @WinServer12R2_64Bit
  ...
  @PlatformBVT @PlatformRegressions
  Scenario Outline: Validate REST GET endpoint for feature to package mapping API-C3849956
    Given User read data from excel with rowIndex "<RowIndex>"
    When User send a Post request for package mapping API as "<Endpoint>"
    Then User should validate the "<code>" as in response
    When User send a Get request for feature API endpoint as "<Endpoint>"
    Then User should validate the status code as "200"OK
    And User should fetch response for API

    Examples: 
      |RowIndex | Endpoint       			| code | 
      |1		| /agent/v1/features/		| 201  |

  
  @PlatformRegressions @Win7_32Bit @Win7_64Bit @Win8_32Bit @Win8_64Bit @Win10_32Bit @Win10_64Bit @Win8.1_32Bit @WinServer8_64Bit @WinServer12_64Bit @WinServer16_64Bit @WinServer12R2_64Bit
  ...
  @Win7_32Bit @Win7_64Bit @Win8_32Bit @Win8_64Bit @Win10_32Bit @Win10_64Bit @Win8.1_32Bit @WinServer8_64Bit @WinServer12_64Bit @WinServer16_64Bit @WinServer12R2_64Bit @platformSanity
  Scenario Outline: Verify POST config/schedule request sent to Agent Core is handled when agent is online-C1320105,C1320098
    ...
    Then User fetch AgentCore EndPointID from agentCore config file from tag
    And User send a Post request for mailbox API endpoint as "<EndPoint>"
    Then User should validate the status code as "200"OK
    And User should fetch response for API
  ...
  Scenario Outline: Verify error code generated on sending(POST) config/schedule with invalid schedule message-C1349818,C1320106
    ...
    When User read data from excel with rowIndex "<RowIndex>"
    Then User fetch AgentCore EndPointID from agentCore config file from tag
    And User send a Post request for errors for API endpoint as "<EndPoint>"
    Then User should verify the status code as "<StatusCode>"
    Then User validate the error details with "<ExpectedResult>"
  ...
  @PlatformBVT @PlatformRegressions @Win7_32Bit @Win7_64Bit @Win8_32Bit @Win8_64Bit @Win10_32Bit @Win10_64Bit @Win8.1_32Bit @WinServer8_64Bit @WinServer12_64Bit @WinServer16_64Bit @WinServer12R2_64Bit @platformSanity
  ...
  @PlatformBVT @PlatformRegressions @Win10_64Bit @platformSanity
  ...
  Scenario Outline: Validate REST response format for Heartbeat API
    ...
    And User fetch AgentCore EndPointID from agentCore config file from tag
    When User fetch registry values of old RMM agent
    Then User send a POST request for API endpoint as "<POSTENDPoint>"
  ...
  Scenario Outline: Verify agent gets Uninstalled through mailbox uninstall message-C2473230
    ...
    And User send a configuration change Post request for mailbox API endpoint as "<EndPoint>"
    Then User should validate the status code as "200"OK
  ...
  Scenario Outline: Verify agent gets Uninstalled when server sends DELETE request to Heartbeat API-C2425456
    ...
    And User fetch AgentCore EndPointID from agentCore config file for "<OSEdition>"
  ...
  @PlatformBVT @PlatformRegressions @Win10_64Bit
  ...
  @PlatformRegressions @Win7_64Bit @Win8_32Bit @Win8_64Bit @Win10_32Bit @Win10_64Bit @Win8.1_32Bit @WinServer8_64Bit @WinServer12_64Bit @WinServer16_64Bit @WinServer12R2_64Bit
  Scenario Outline: Validate heartbeat data for invalid EndpointID-C2432675
    Given SSH connection establishes with remote test machine from tag
    And User fetch AgentCore EndPointID from agentCore config file from tag
    When User fetch registry values of old RMM agent
    Then User send a POST request for API endpoint with header as "<POSTENDPoint>"
  ...
  @PlatformRegressions @Win7_64Bit @Win8_32Bit @Win8_64Bit @Win10_32Bit @Win10_64Bit @Win8.1_32Bit @WinServer8_64Bit @WinServer12_64Bit @WinServer16_64Bit @WinServer12R2_64Bit @platformSanity
  ...
  Scenario Outline: Validate GET API to return Endpoint based on Partner and Legacy RegID-C2517221
    ...
    And User fetch AgentCore EndPointID from agentCore config file from tag
    When User fetch registry values of old RMM agent
    Then User send a Get request for API based on partner and legacy regID "<GETENDPoint>"
    And User should fetch response for API
  ...
  @PlatformRegressions @Win7_32Bit @Win7_64Bit @Win8_32Bit @Win8_64Bit @Win10_32Bit @Win10_64Bit @Win8.1_32Bit @WinXP_32Bit @WinXP_64Bit @WinVista_32Bit @WinVista_64Bit @WinServer8_64Bit @WinServer12_64Bit @WinServer16_64Bit @WinServer12R2_64Bit
  Scenario Outline: Validating MD5 checksum values returned from AMS-C2823612
    Given SSH connection establishes with remote test machine from tag
    And User fetch AgentCore EndPointID from agentCore config file from tag
    When User send a agent configuration change Post request with header and endpoint as "<POSTENDPOINT>" and hashcode as "<HASHCODE>"
    Then User should validate the "<Statuscode>" as in response
